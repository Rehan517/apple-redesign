    ...
    return (
        <div>
            ...
            <main className='grid grid-cols-1 lg:grid-cols-9'>
                <section className='order-2 lg:col-span-5 mx-auto max-w-xl pb-12 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44'>
                    ...
                    <div className='mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14'>
                        <div className='space-y-2 pb-3'>
                            ...
                            <p className='text-sm text-gray-600'>We've accepted your order, and we're getting it ready. Come back
                    ...
                    <div className='my-4 mx-4 space-y-2 rounded-md border border-gray-300 p-4 lg:ml-14'>
                        ...
                        <p className='text-sm text-gray-600'>
                            You'll get shipping and delivery updates by email and text</p>
                    </div>
                ...
                {mounted && (
                    <section className='overflow-y-scroll border-y border-l border-gray-300 bg-[#fafafa] lg:order-2 lg:col-span-4
                    lg:h-screen lg:border-y-0'>
                        <div
                        ...
                        {showOrderSummaryCondition && (
                            <div className='mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0
                            lg:max-w-lg lg:px-10 lg:py-16'>
                                <div className='space-y-4 pb-4'>
                                    {products.map((product) => (
                                        <div key={product.id} className='flex items-center space-x-4 text-sm font-medium'>
                                            <div className='relative flex h-16 w-16 items-center justify-center rounded-md border border-gray-300
                                            bg-[#f1f1f1] text-xs text-white'>
                                ...
                                <div className='flex justify-between pt-4'>
                                        ...
                                        <p className='flex items-center gap-x-2 text-xs text-[gray]'>
                                            USD 
                                            <span className='text-xl font-medium text-black'>${subtotal + 20}</span>
                                        </p>
                                </div>
                            </div>
                        )}
